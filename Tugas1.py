...
def tfidf_calculation():
    ...
    st.sidebar.subheader("Pilih Opsi Preprocessing:")
    ...
    if opsi_preprocessing == "Input Link Github":
        link = st.text_input("Masukkan Link URL Github:", "https://raw.githubusercontent.com/20-184Bagas/ppw/main/hasil_tfidf1.csv")
